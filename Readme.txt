...
*
*
 #### Welcome to Recruitment Web Application ####

 1. Main 'Controller.js' which is present in the root directory

 2. Run the 'Controller.js' to run the application.
 
 3. Please reachout the base url to access the Application
        BasePath = 'http://localhost:3000/recruitmentApp' 
